...
FunctionsToExport = 'Set-AdAclChangeSite', 'Set-AdAclChangeSiteLink', 
               ...
               'Set-AdAclRSoPPlanning', 'Set-GpoFileSecurity', 
               'Set-GpoPrivilegeRight', 'Set-GpoRegistryKey', 
               'Set-GpoRestrictedGroup', 'Rename-AdAclGroup', 'Set-AdAclChangeGroup', 
               'Set-AdAclCreateDeleteGroup', 'Set-AdAclUserGroupMembership', 
               'Write-CustomDebug', 'Write-CustomError', 'Write-CustomLog', 
               'Write-CustomVerbose', 'Write-CustomWarning', 'Get-AclAccessRule', 
               'Get-AclAuditRule', 'Get-AttributeSchemaHashTable', 
               'Get-ExtendedRightHashTable', 'Import-MyModule', 
               ...
               'Set-AdAclFullControlDHCP', 'Set-AdAclPromoteDomain', 
               'Set-AdInheritance', 'Set-CreateDeleteInetOrgPerson', 
               'Set-AdAclMngPrivilegedAccount', 'Set-AdAclMngPrivilegedGroup', 
               'Rename-AdAclOU', 'Set-AdAclChangeOU', 'Set-AdAclCreateDeleteOU', 
               'Set-AdAclPkiAdmin', 'Set-AdAclPkiTemplateAdmin', 
               'Rename-AdAclPrintQueue', 'Set-AdAclChangePrintQueue', 
               'Set-AdAclCreateDeletePrintQueue', 'Set-AdAclCreateDeleteGMSA', 
               'Set-AdAclCreateDeleteMSA', 'Add-GroupToSCManager', 'Add-ServiceAcl', 
               'Get-SCManagerPermission', 'Get-ServiceAcl', 
               'Remove-GroupFromSCManager', 'Remove-ServiceAcl', 
               'Set-ServicePermission', 'Rename-AdAclUser', 
               'Set-AdAclChangeUserPassword', 'Set-AdAclCreateDeleteUser', 
               'Set-AdAclEnableDisableUser', 'Set-AdAclResetUserPassword', 
               'Set-AdAclUnlockUser', 'Set-AdAclUserAccountRestriction', 
               'Set-AdAclUserEmailInfo', 'Set-AdAclUserGeneralInfo', 
               'Set-AdAclUserGroupMembership', 'Set-AdAclUserLogonInfo', 
