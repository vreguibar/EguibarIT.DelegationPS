...
function Set-AdAclUserPersonalInfo {
    <#
        .SYNOPSIS
            Delegates permissions to a group for modifying User Personal Information properties in an OU.

        .DESCRIPTION
            The Set-AdAclUserPersonalInfo function delegates the necessary Active Directory permissions
            to allow a specified group to read and modify Personal Information properties of user
            ...
            permissions for the Personal Information property set to the specified group. The permissions
            ...
            The Personal Information property set includes attributes such as:
            - Home Address
            - Phone Numbers
        ...
        .EXAMPLE
            ...
            Personal Information properties of user objects in the specified OU.
    ...
    Process {
        ...
        If ($Force -or $PSCmdlet.ShouldProcess($PSBoundParameters['Group'], 'Delegate the permissions for Personal Information?')) {
    ...
    End {
        ...
        $txt = ($Variables.FooterDelegation -f $MyInvocation.InvocationName,
            'delegating of user personal info.'
        )
        Write-Verbose -Message $txt
    } #end END
}
