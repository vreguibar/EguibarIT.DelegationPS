...
function Set-AdAclUserWebInfo {
    <#
        .Synopsis
            ...
            User Web Information Set of user in an OU
        .DESCRIPTION
            The function will delegate the premission for a group to Modify Web Information Set of user object
        .EXAMPLE
    ...
    End {
        ...
        Write-Verbose -Message "Function $($MyInvocation.InvocationName) finish user web info."
        Write-Verbose -Message ''
        Write-Verbose -Message '--------------------------------------------------------------------------------'
        Write-Verbose -Message ''
    } #end END
