...
function Set-AdAclUserGroupMembership {
    <#
        ...
        .DESCRIPTION
            The function will delegate the permission for a group to Modify Group Membership Set of user object
        .EXAMPLE
    ...
    Process {
        ...
        If ($Force -or $PSCmdlet.ShouldProcess($PSBoundParameters['Group'], 'Delegate the permissions for Group Membership?')) {
    ...
    End {
        ...
        $txt = ($Variables.FooterDelegation -f $MyInvocation.InvocationName,
            'delegating of user group membership.'
        )
        Write-Verbose -Message $txt
    } #end END
}
