...
function Set-AdAclUserEmailInfo {
    <#
        ...
        .DESCRIPTION
            The function will delegate the permission for a group to Modify Phone and Mail Options Set of user object
        .EXAMPLE
    ...
    Process {
        ...
        If ($Force -or $PSCmdlet.ShouldProcess($PSBoundParameters['Group'], 'Delegate the permissions for Phone and Mail Options?')) {
