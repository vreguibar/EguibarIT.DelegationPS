...
function Set-AdAclUserGeneralInfo {
    <#
        ...
        .DESCRIPTION
            The function will delegate the permission for a group to Modify General Information Set of user object
        .EXAMPLE
    ...
    Process {
        ...
        If ($Force -or $PSCmdlet.ShouldProcess($PSBoundParameters['Group'], 'Delegate the permissions for General Information?')) {
    ...
    End {
        ...
        $txt = ($Constants.Footer -f $MyInvocation.InvocationName,
            'delegating of user email General info.'
        )
        Write-Verbose -Message $txt
    } #end END
}
