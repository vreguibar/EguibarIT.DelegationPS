Function Set-AdAclRSoPLogging {
    ...
    Process {
        ...
        If ($Force -or $PSCmdlet.ShouldProcess($PSBoundParameters['Group'], 'Delegate the permissions for Generate Resultant Set of Policy (Logging)?')) {
