function Set-AdAclChangeComputerPassword {
  ...
  AdSecurityInheritance :  Descendents
        ...
        If ($Force -or $PSCmdlet.ShouldProcess($PSBoundParameters['Group'], 'Delegate the permisssions to Change Password?')) {
    ...
    End {
        ...
        Write-Verbose -Message "Function $($MyInvocation.InvocationName) finished delegating change computer password."
