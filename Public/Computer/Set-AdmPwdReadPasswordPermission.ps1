...
function Set-AdmPwdReadPasswordPermission {
    <#
        ...
        .DESCRIPTION
            LAPS implementation. The function will delegate the permission for a group to read Admin password of Computer object
        .EXAMPLE
    ...
    End {
        ...
        $txt = ($Variables.FooterDelegation -f $MyInvocation.InvocationName,
            'delegating change PWD Rear-Write Password.'
        )
        Write-Verbose -Message $txt
    } #end END
}
