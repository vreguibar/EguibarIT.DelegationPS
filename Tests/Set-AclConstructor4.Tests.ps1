...
BeforeAll {
    ...
    function Set-AclConstructor4Testing {
...
Describe 'Set-AclConstructor4' {
    ...
    Context 'Parameter Validation' {
        It 'Should throw when Id is null or empty' {
            ...
            { Set-AclConstructor4Testing @params } | Should -Throw
        }
        ...
        It 'Should accept valid parameters' {
            ...
            { Set-AclConstructor4Testing @params } | Should -Not -Throw
        }
    }
    ...
    Context 'Identity Resolution' {
        ...
        It 'Should resolve AD objects' {
            ...
            Set-AclConstructor4Testing @params
        }
...
AfterAll {
    ...
    foreach ($FunctionName in @('Test-IsValidDN', 'Get-FunctionDisplay', 'Get-AdObjectType', 'Set-AclConstructor4Testing')) {
